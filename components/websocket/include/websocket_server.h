...
int ws_server_send_binary_all(uint8_t *msg, uint64_t len);  // sends binary to all clients
...
int ws_server_send_binary_all_from_callback(uint8_t *msg, uint64_t len); // sends binary to all clients
